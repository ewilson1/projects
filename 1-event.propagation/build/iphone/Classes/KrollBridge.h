...
@interface eventpropagationObject : KrollCoverageObject {
#else
@interface eventpropagationObject : KrollObject {
#endif
@private
...
extern NSString * eventpropagation$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	eventpropagationObject *_eventpropagation;
    KrollObject* console;
	BOOL shutdown;
