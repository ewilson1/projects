...
//@interface eventpropagationObject : NSObject
//@end

@interface eventpropagationObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[eventpropagationObject class]])
		{
			for (NSString *key in [[(eventpropagationObject*)o modules] allKeys])
			{
