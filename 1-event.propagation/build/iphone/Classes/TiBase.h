...
// in simulator we redefine to format for eventpropagation Developer console
...
{\
	NSString * exceptionName = [@"org.eventpropagation." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.eventpropagation";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIeventpropagationNativeItemNone = -1, 
	UIeventpropagationNativeItemSpinner = -2,
	UIeventpropagationNativeItemProgressBar = -3,
	
	UIeventpropagationNativeItemSlider = -4,
	UIeventpropagationNativeItemSwitch = -5,
	UIeventpropagationNativeItemMultiButton = -6,
	UIeventpropagationNativeItemSegmented = -7,
	
	UIeventpropagationNativeItemTextView = -8,
	UIeventpropagationNativeItemTextField = -9,
	UIeventpropagationNativeItemSearchBar = -10,
	
	UIeventpropagationNativeItemPicker = -11,
	UIeventpropagationNativeItemDatePicker = -12,
	
	UIeventpropagationNativeItemInfoLight = -13,
	UIeventpropagationNativeItemInfoDark = -14,
	
	UIeventpropagationNativeItemDisclosure = -15,
	
	UIeventpropagationNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all eventpropagation instances of
