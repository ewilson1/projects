...
//Rare exceptions to indicate a bug in the _eventpropagation code (Eg, function that a subclass should have implemented)
...
/**
 The base class for eventpropagation proxies.
 */
