...
/**
 Base class for all eventpropagation views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the eventpropagation view hierarchy (such as wrapped iOS UIViews) was touched.
