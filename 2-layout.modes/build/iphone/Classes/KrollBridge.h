...
@interface k2_layoutmodesObject : KrollCoverageObject {
#else
@interface k2_layoutmodesObject : KrollObject {
#endif
@private
...
extern NSString * k2_layoutmodes$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k2_layoutmodesObject *_k2_layoutmodes;
    KrollObject* console;
	BOOL shutdown;
