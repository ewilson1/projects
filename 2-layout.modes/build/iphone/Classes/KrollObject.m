...
//@interface k2_layoutmodesObject : NSObject
//@end

@interface k2_layoutmodesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k2_layoutmodesObject class]])
		{
			for (NSString *key in [[(k2_layoutmodesObject*)o modules] allKeys])
			{
