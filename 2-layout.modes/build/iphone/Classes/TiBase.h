...
// in simulator we redefine to format for k2_layoutmodes Developer console
...
{\
	NSString * exceptionName = [@"org.k2_layoutmodes." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k2_layoutmodes";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk2_layoutmodesNativeItemNone = -1, 
	UIk2_layoutmodesNativeItemSpinner = -2,
	UIk2_layoutmodesNativeItemProgressBar = -3,
	
	UIk2_layoutmodesNativeItemSlider = -4,
	UIk2_layoutmodesNativeItemSwitch = -5,
	UIk2_layoutmodesNativeItemMultiButton = -6,
	UIk2_layoutmodesNativeItemSegmented = -7,
	
	UIk2_layoutmodesNativeItemTextView = -8,
	UIk2_layoutmodesNativeItemTextField = -9,
	UIk2_layoutmodesNativeItemSearchBar = -10,
	
	UIk2_layoutmodesNativeItemPicker = -11,
	UIk2_layoutmodesNativeItemDatePicker = -12,
	
	UIk2_layoutmodesNativeItemInfoLight = -13,
	UIk2_layoutmodesNativeItemInfoDark = -14,
	
	UIk2_layoutmodesNativeItemDisclosure = -15,
	
	UIk2_layoutmodesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k2_layoutmodes instances of
