...
//Rare exceptions to indicate a bug in the _k2_layoutmodes code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k2_layoutmodes proxies.
 */
