...
/**
 Base class for all k2_layoutmodes views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k2_layoutmodes view hierarchy (such as wrapped iOS UIViews) was touched.
