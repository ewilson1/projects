...
@interface k3_scrollviewsObject : KrollCoverageObject {
#else
@interface k3_scrollviewsObject : KrollObject {
#endif
@private
...
extern NSString * k3_scrollviews$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k3_scrollviewsObject *_k3_scrollviews;
    KrollObject* console;
	BOOL shutdown;
