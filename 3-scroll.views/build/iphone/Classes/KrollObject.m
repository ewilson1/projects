...
//@interface k3_scrollviewsObject : NSObject
//@end

@interface k3_scrollviewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k3_scrollviewsObject class]])
		{
			for (NSString *key in [[(k3_scrollviewsObject*)o modules] allKeys])
			{
