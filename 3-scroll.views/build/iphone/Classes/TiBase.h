...
// in simulator we redefine to format for k3_scrollviews Developer console
...
{\
	NSString * exceptionName = [@"org.k3_scrollviews." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k3_scrollviews";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk3_scrollviewsNativeItemNone = -1, 
	UIk3_scrollviewsNativeItemSpinner = -2,
	UIk3_scrollviewsNativeItemProgressBar = -3,
	
	UIk3_scrollviewsNativeItemSlider = -4,
	UIk3_scrollviewsNativeItemSwitch = -5,
	UIk3_scrollviewsNativeItemMultiButton = -6,
	UIk3_scrollviewsNativeItemSegmented = -7,
	
	UIk3_scrollviewsNativeItemTextView = -8,
	UIk3_scrollviewsNativeItemTextField = -9,
	UIk3_scrollviewsNativeItemSearchBar = -10,
	
	UIk3_scrollviewsNativeItemPicker = -11,
	UIk3_scrollviewsNativeItemDatePicker = -12,
	
	UIk3_scrollviewsNativeItemInfoLight = -13,
	UIk3_scrollviewsNativeItemInfoDark = -14,
	
	UIk3_scrollviewsNativeItemDisclosure = -15,
	
	UIk3_scrollviewsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k3_scrollviews instances of
