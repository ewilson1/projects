...
/**
 Base class for all k3_scrollviews views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k3_scrollviews view hierarchy (such as wrapped iOS UIViews) was touched.
