...
@interface k4_imageviewsObject : KrollCoverageObject {
#else
@interface k4_imageviewsObject : KrollObject {
#endif
@private
...
extern NSString * k4_imageviews$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k4_imageviewsObject *_k4_imageviews;
    KrollObject* console;
	BOOL shutdown;
