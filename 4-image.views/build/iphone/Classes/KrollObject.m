...
//@interface k4_imageviewsObject : NSObject
//@end

@interface k4_imageviewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k4_imageviewsObject class]])
		{
			for (NSString *key in [[(k4_imageviewsObject*)o modules] allKeys])
			{
