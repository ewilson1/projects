...
// in simulator we redefine to format for k4_imageviews Developer console
...
{\
	NSString * exceptionName = [@"org.k4_imageviews." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k4_imageviews";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk4_imageviewsNativeItemNone = -1, 
	UIk4_imageviewsNativeItemSpinner = -2,
	UIk4_imageviewsNativeItemProgressBar = -3,
	
	UIk4_imageviewsNativeItemSlider = -4,
	UIk4_imageviewsNativeItemSwitch = -5,
	UIk4_imageviewsNativeItemMultiButton = -6,
	UIk4_imageviewsNativeItemSegmented = -7,
	
	UIk4_imageviewsNativeItemTextView = -8,
	UIk4_imageviewsNativeItemTextField = -9,
	UIk4_imageviewsNativeItemSearchBar = -10,
	
	UIk4_imageviewsNativeItemPicker = -11,
	UIk4_imageviewsNativeItemDatePicker = -12,
	
	UIk4_imageviewsNativeItemInfoLight = -13,
	UIk4_imageviewsNativeItemInfoDark = -14,
	
	UIk4_imageviewsNativeItemDisclosure = -15,
	
	UIk4_imageviewsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k4_imageviews instances of
