...
/**
 Base class for all k4_imageviews views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k4_imageviews view hierarchy (such as wrapped iOS UIViews) was touched.
