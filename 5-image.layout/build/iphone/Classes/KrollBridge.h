...
@interface k5_imagelayoutObject : KrollCoverageObject {
#else
@interface k5_imagelayoutObject : KrollObject {
#endif
@private
...
extern NSString * k5_imagelayout$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k5_imagelayoutObject *_k5_imagelayout;
    KrollObject* console;
	BOOL shutdown;
