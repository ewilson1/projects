...
// in simulator we redefine to format for k5_imagelayout Developer console
...
{\
	NSString * exceptionName = [@"org.k5_imagelayout." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k5_imagelayout";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk5_imagelayoutNativeItemNone = -1, 
	UIk5_imagelayoutNativeItemSpinner = -2,
	UIk5_imagelayoutNativeItemProgressBar = -3,
	
	UIk5_imagelayoutNativeItemSlider = -4,
	UIk5_imagelayoutNativeItemSwitch = -5,
	UIk5_imagelayoutNativeItemMultiButton = -6,
	UIk5_imagelayoutNativeItemSegmented = -7,
	
	UIk5_imagelayoutNativeItemTextView = -8,
	UIk5_imagelayoutNativeItemTextField = -9,
	UIk5_imagelayoutNativeItemSearchBar = -10,
	
	UIk5_imagelayoutNativeItemPicker = -11,
	UIk5_imagelayoutNativeItemDatePicker = -12,
	
	UIk5_imagelayoutNativeItemInfoLight = -13,
	UIk5_imagelayoutNativeItemInfoDark = -14,
	
	UIk5_imagelayoutNativeItemDisclosure = -15,
	
	UIk5_imagelayoutNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k5_imagelayout instances of
