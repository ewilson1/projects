...
/**
 Base class for all k5_imagelayout views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k5_imagelayout view hierarchy (such as wrapped iOS UIViews) was touched.
