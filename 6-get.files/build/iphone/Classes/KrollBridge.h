...
@interface k6_getfilesObject : KrollCoverageObject {
#else
@interface k6_getfilesObject : KrollObject {
#endif
@private
...
extern NSString * k6_getfiles$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k6_getfilesObject *_k6_getfiles;
    KrollObject* console;
	BOOL shutdown;
