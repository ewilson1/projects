...
//@interface k6_getfilesObject : NSObject
//@end

@interface k6_getfilesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k6_getfilesObject class]])
		{
			for (NSString *key in [[(k6_getfilesObject*)o modules] allKeys])
			{
