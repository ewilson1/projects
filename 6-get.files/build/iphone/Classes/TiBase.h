...
// in simulator we redefine to format for k6_getfiles Developer console
...
{\
	NSString * exceptionName = [@"org.k6_getfiles." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k6_getfiles";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk6_getfilesNativeItemNone = -1, 
	UIk6_getfilesNativeItemSpinner = -2,
	UIk6_getfilesNativeItemProgressBar = -3,
	
	UIk6_getfilesNativeItemSlider = -4,
	UIk6_getfilesNativeItemSwitch = -5,
	UIk6_getfilesNativeItemMultiButton = -6,
	UIk6_getfilesNativeItemSegmented = -7,
	
	UIk6_getfilesNativeItemTextView = -8,
	UIk6_getfilesNativeItemTextField = -9,
	UIk6_getfilesNativeItemSearchBar = -10,
	
	UIk6_getfilesNativeItemPicker = -11,
	UIk6_getfilesNativeItemDatePicker = -12,
	
	UIk6_getfilesNativeItemInfoLight = -13,
	UIk6_getfilesNativeItemInfoDark = -14,
	
	UIk6_getfilesNativeItemDisclosure = -15,
	
	UIk6_getfilesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k6_getfiles instances of
