...
/**
 Base class for all k6_getfiles views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k6_getfiles view hierarchy (such as wrapped iOS UIViews) was touched.
