 ...
 * to send analytic data that can be viewed on the k7_puttingitalltogether Dashboard.
 *
 * For information on getting started with k7_puttingitalltogether Platform Services,
