...
@interface k7_puttingitalltogetherObject : KrollCoverageObject {
#else
@interface k7_puttingitalltogetherObject : KrollObject {
#endif
@private
...
extern NSString * k7_puttingitalltogether$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k7_puttingitalltogetherObject *_k7_puttingitalltogether;
    KrollObject* console;
	BOOL shutdown;
