...
//@interface k7_puttingitalltogetherObject : NSObject
//@end

@interface k7_puttingitalltogetherObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k7_puttingitalltogetherObject class]])
		{
			for (NSString *key in [[(k7_puttingitalltogetherObject*)o modules] allKeys])
			{
