...
// in simulator we redefine to format for k7_puttingitalltogether Developer console
...
{\
	NSString * exceptionName = [@"org.k7_puttingitalltogether." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k7_puttingitalltogether";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk7_puttingitalltogetherNativeItemNone = -1, 
	UIk7_puttingitalltogetherNativeItemSpinner = -2,
	UIk7_puttingitalltogetherNativeItemProgressBar = -3,
	
	UIk7_puttingitalltogetherNativeItemSlider = -4,
	UIk7_puttingitalltogetherNativeItemSwitch = -5,
	UIk7_puttingitalltogetherNativeItemMultiButton = -6,
	UIk7_puttingitalltogetherNativeItemSegmented = -7,
	
	UIk7_puttingitalltogetherNativeItemTextView = -8,
	UIk7_puttingitalltogetherNativeItemTextField = -9,
	UIk7_puttingitalltogetherNativeItemSearchBar = -10,
	
	UIk7_puttingitalltogetherNativeItemPicker = -11,
	UIk7_puttingitalltogetherNativeItemDatePicker = -12,
	
	UIk7_puttingitalltogetherNativeItemInfoLight = -13,
	UIk7_puttingitalltogetherNativeItemInfoDark = -14,
	
	UIk7_puttingitalltogetherNativeItemDisclosure = -15,
	
	UIk7_puttingitalltogetherNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k7_puttingitalltogether instances of
