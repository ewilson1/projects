...
//Rare exceptions to indicate a bug in the _k7_puttingitalltogether code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k7_puttingitalltogether proxies.
 */
