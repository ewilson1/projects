...
/**
 Base class for all k7_puttingitalltogether views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k7_puttingitalltogether view hierarchy (such as wrapped iOS UIViews) was touched.
