...
// in simulator we redefine to format for Week3 Developer console
...
{\
	NSString * exceptionName = [@"org.week3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek3NativeItemNone = -1, 
	UIWeek3NativeItemSpinner = -2,
	UIWeek3NativeItemProgressBar = -3,
	
	UIWeek3NativeItemSlider = -4,
	UIWeek3NativeItemSwitch = -5,
	UIWeek3NativeItemMultiButton = -6,
	UIWeek3NativeItemSegmented = -7,
	
	UIWeek3NativeItemTextView = -8,
	UIWeek3NativeItemTextField = -9,
	UIWeek3NativeItemSearchBar = -10,
	
	UIWeek3NativeItemPicker = -11,
	UIWeek3NativeItemDatePicker = -12,
	
	UIWeek3NativeItemInfoLight = -13,
	UIWeek3NativeItemInfoDark = -14,
	
	UIWeek3NativeItemDisclosure = -15,
	
	UIWeek3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Week3 instances of
