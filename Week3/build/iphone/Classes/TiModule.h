...
/**
 The base class for all Week3 modules
 */
...
/**
 Week3 Platform calls this method on startup.
 */
-(void)startup;

/**
 Week3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Week3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Week3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Week3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
