...
//@interface WindowsObject : NSObject
//@end

@interface WindowsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WindowsObject class]])
		{
			for (NSString *key in [[(WindowsObject*)o modules] allKeys])
			{
