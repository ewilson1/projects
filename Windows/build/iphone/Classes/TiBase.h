...
// in simulator we redefine to format for Windows Developer console
...
{\
	NSString * exceptionName = [@"org.windows." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.windows";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWindowsNativeItemNone = -1, 
	UIWindowsNativeItemSpinner = -2,
	UIWindowsNativeItemProgressBar = -3,
	
	UIWindowsNativeItemSlider = -4,
	UIWindowsNativeItemSwitch = -5,
	UIWindowsNativeItemMultiButton = -6,
	UIWindowsNativeItemSegmented = -7,
	
	UIWindowsNativeItemTextView = -8,
	UIWindowsNativeItemTextField = -9,
	UIWindowsNativeItemSearchBar = -10,
	
	UIWindowsNativeItemPicker = -11,
	UIWindowsNativeItemDatePicker = -12,
	
	UIWindowsNativeItemInfoLight = -13,
	UIWindowsNativeItemInfoDark = -14,
	
	UIWindowsNativeItemDisclosure = -15,
	
	UIWindowsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Windows instances of
