...
// in simulator we redefine to format for add Developer console
...
{\
	NSString * exceptionName = [@"org.add." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.add";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIaddNativeItemNone = -1, 
	UIaddNativeItemSpinner = -2,
	UIaddNativeItemProgressBar = -3,
	
	UIaddNativeItemSlider = -4,
	UIaddNativeItemSwitch = -5,
	UIaddNativeItemMultiButton = -6,
	UIaddNativeItemSegmented = -7,
	
	UIaddNativeItemTextView = -8,
	UIaddNativeItemTextField = -9,
	UIaddNativeItemSearchBar = -10,
	
	UIaddNativeItemPicker = -11,
	UIaddNativeItemDatePicker = -12,
	
	UIaddNativeItemInfoLight = -13,
	UIaddNativeItemInfoDark = -14,
	
	UIaddNativeItemDisclosure = -15,
	
	UIaddNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all add instances of
