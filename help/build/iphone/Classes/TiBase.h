...
// in simulator we redefine to format for help Developer console
...
{\
	NSString * exceptionName = [@"org.help." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.help";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIhelpNativeItemNone = -1, 
	UIhelpNativeItemSpinner = -2,
	UIhelpNativeItemProgressBar = -3,
	
	UIhelpNativeItemSlider = -4,
	UIhelpNativeItemSwitch = -5,
	UIhelpNativeItemMultiButton = -6,
	UIhelpNativeItemSegmented = -7,
	
	UIhelpNativeItemTextView = -8,
	UIhelpNativeItemTextField = -9,
	UIhelpNativeItemSearchBar = -10,
	
	UIhelpNativeItemPicker = -11,
	UIhelpNativeItemDatePicker = -12,
	
	UIhelpNativeItemInfoLight = -13,
	UIhelpNativeItemInfoDark = -14,
	
	UIhelpNativeItemDisclosure = -15,
	
	UIhelpNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all help instances of
