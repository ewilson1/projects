...
/**
 The base class for all help modules
 */
...
/**
 help Platform calls this method on startup.
 */
-(void)startup;

/**
 help Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 help Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 help Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 help Platform calls this method on resume.
 @param sender The sender of the event.
 */
