...
@interface navigationObject : KrollCoverageObject {
#else
@interface navigationObject : KrollObject {
#endif
@private
...
extern NSString * navigation$ModuleRequireFormat;
