...
// in simulator we redefine to format for navigation Developer console
...
{\
	NSString * exceptionName = [@"org.navigation." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.navigation";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UInavigationNativeItemNone = -1, 
	UInavigationNativeItemSpinner = -2,
	UInavigationNativeItemProgressBar = -3,
	
	UInavigationNativeItemSlider = -4,
	UInavigationNativeItemSwitch = -5,
	UInavigationNativeItemMultiButton = -6,
	UInavigationNativeItemSegmented = -7,
	
	UInavigationNativeItemTextView = -8,
	UInavigationNativeItemTextField = -9,
	UInavigationNativeItemSearchBar = -10,
	
	UInavigationNativeItemPicker = -11,
	UInavigationNativeItemDatePicker = -12,
	
	UInavigationNativeItemInfoLight = -13,
	UInavigationNativeItemInfoDark = -14,
	
	UInavigationNativeItemDisclosure = -15,
	
	UInavigationNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all navigation instances of
