...
/**
 Base class for all navigation views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the navigation view hierarchy (such as wrapped iOS UIViews) was touched.
