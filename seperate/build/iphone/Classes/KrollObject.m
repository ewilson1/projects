...
//@interface seperateObject : NSObject
//@end

@interface seperateObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[seperateObject class]])
		{
			for (NSString *key in [[(seperateObject*)o modules] allKeys])
			{
