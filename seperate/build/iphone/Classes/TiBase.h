...
// in simulator we redefine to format for seperate Developer console
...
{\
	NSString * exceptionName = [@"org.seperate." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.seperate";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIseperateNativeItemNone = -1, 
	UIseperateNativeItemSpinner = -2,
	UIseperateNativeItemProgressBar = -3,
	
	UIseperateNativeItemSlider = -4,
	UIseperateNativeItemSwitch = -5,
	UIseperateNativeItemMultiButton = -6,
	UIseperateNativeItemSegmented = -7,
	
	UIseperateNativeItemTextView = -8,
	UIseperateNativeItemTextField = -9,
	UIseperateNativeItemSearchBar = -10,
	
	UIseperateNativeItemPicker = -11,
	UIseperateNativeItemDatePicker = -12,
	
	UIseperateNativeItemInfoLight = -13,
	UIseperateNativeItemInfoDark = -14,
	
	UIseperateNativeItemDisclosure = -15,
	
	UIseperateNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all seperate instances of
