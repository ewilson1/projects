...
// in simulator we redefine to format for teas Developer console
...
{\
	NSString * exceptionName = [@"org.teas." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.teas";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIteasNativeItemNone = -1, 
	UIteasNativeItemSpinner = -2,
	UIteasNativeItemProgressBar = -3,
	
	UIteasNativeItemSlider = -4,
	UIteasNativeItemSwitch = -5,
	UIteasNativeItemMultiButton = -6,
	UIteasNativeItemSegmented = -7,
	
	UIteasNativeItemTextView = -8,
	UIteasNativeItemTextField = -9,
	UIteasNativeItemSearchBar = -10,
	
	UIteasNativeItemPicker = -11,
	UIteasNativeItemDatePicker = -12,
	
	UIteasNativeItemInfoLight = -13,
	UIteasNativeItemInfoDark = -14,
	
	UIteasNativeItemDisclosure = -15,
	
	UIteasNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all teas instances of
