...
@interface week_4_practiceObject : KrollCoverageObject {
#else
@interface week_4_practiceObject : KrollObject {
#endif
@private
...
extern NSString * week_4_practice$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	week_4_practiceObject *_week_4_practice;
    KrollObject* console;
	BOOL shutdown;
