...
//@interface week_4_practiceObject : NSObject
//@end

@interface week_4_practiceObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[week_4_practiceObject class]])
		{
			for (NSString *key in [[(week_4_practiceObject*)o modules] allKeys])
			{
