...
// in simulator we redefine to format for week_4_practice Developer console
...
{\
	NSString * exceptionName = [@"org.week_4_practice." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week_4_practice";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIweek_4_practiceNativeItemNone = -1, 
	UIweek_4_practiceNativeItemSpinner = -2,
	UIweek_4_practiceNativeItemProgressBar = -3,
	
	UIweek_4_practiceNativeItemSlider = -4,
	UIweek_4_practiceNativeItemSwitch = -5,
	UIweek_4_practiceNativeItemMultiButton = -6,
	UIweek_4_practiceNativeItemSegmented = -7,
	
	UIweek_4_practiceNativeItemTextView = -8,
	UIweek_4_practiceNativeItemTextField = -9,
	UIweek_4_practiceNativeItemSearchBar = -10,
	
	UIweek_4_practiceNativeItemPicker = -11,
	UIweek_4_practiceNativeItemDatePicker = -12,
	
	UIweek_4_practiceNativeItemInfoLight = -13,
	UIweek_4_practiceNativeItemInfoDark = -14,
	
	UIweek_4_practiceNativeItemDisclosure = -15,
	
	UIweek_4_practiceNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all week_4_practice instances of
