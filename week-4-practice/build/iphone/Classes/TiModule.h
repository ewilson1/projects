...
/**
 The base class for all week_4_practice modules
 */
...
/**
 week_4_practice Platform calls this method on startup.
 */
-(void)startup;

/**
 week_4_practice Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 week_4_practice Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 week_4_practice Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 week_4_practice Platform calls this method on resume.
 @param sender The sender of the event.
 */
