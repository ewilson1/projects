...
//Rare exceptions to indicate a bug in the _week_4_practice code (Eg, function that a subclass should have implemented)
...
/**
 The base class for week_4_practice proxies.
 */
