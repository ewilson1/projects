...
/**
 Base class for all week_4_practice views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the week_4_practice view hierarchy (such as wrapped iOS UIViews) was touched.
