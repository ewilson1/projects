...
// in simulator we redefine to format for week2 Developer console
...
{\
	NSString * exceptionName = [@"org.week2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIweek2NativeItemNone = -1, 
	UIweek2NativeItemSpinner = -2,
	UIweek2NativeItemProgressBar = -3,
	
	UIweek2NativeItemSlider = -4,
	UIweek2NativeItemSwitch = -5,
	UIweek2NativeItemMultiButton = -6,
	UIweek2NativeItemSegmented = -7,
	
	UIweek2NativeItemTextView = -8,
	UIweek2NativeItemTextField = -9,
	UIweek2NativeItemSearchBar = -10,
	
	UIweek2NativeItemPicker = -11,
	UIweek2NativeItemDatePicker = -12,
	
	UIweek2NativeItemInfoLight = -13,
	UIweek2NativeItemInfoDark = -14,
	
	UIweek2NativeItemDisclosure = -15,
	
	UIweek2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all week2 instances of
