...
@interface week3demoObject : KrollCoverageObject {
#else
@interface week3demoObject : KrollObject {
#endif
@private
...
extern NSString * week3demo$ModuleRequireFormat;
