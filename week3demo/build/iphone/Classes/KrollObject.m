...
//@interface week3demoObject : NSObject
//@end

@interface week3demoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[week3demoObject class]])
		{
			for (NSString *key in [[(week3demoObject*)o modules] allKeys])
			{
