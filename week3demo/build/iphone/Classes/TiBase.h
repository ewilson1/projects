...
// in simulator we redefine to format for week3demo Developer console
...
{\
	NSString * exceptionName = [@"org.week3demo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week3demo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIweek3demoNativeItemNone = -1, 
	UIweek3demoNativeItemSpinner = -2,
	UIweek3demoNativeItemProgressBar = -3,
	
	UIweek3demoNativeItemSlider = -4,
	UIweek3demoNativeItemSwitch = -5,
	UIweek3demoNativeItemMultiButton = -6,
	UIweek3demoNativeItemSegmented = -7,
	
	UIweek3demoNativeItemTextView = -8,
	UIweek3demoNativeItemTextField = -9,
	UIweek3demoNativeItemSearchBar = -10,
	
	UIweek3demoNativeItemPicker = -11,
	UIweek3demoNativeItemDatePicker = -12,
	
	UIweek3demoNativeItemInfoLight = -13,
	UIweek3demoNativeItemInfoDark = -14,
	
	UIweek3demoNativeItemDisclosure = -15,
	
	UIweek3demoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all week3demo instances of
