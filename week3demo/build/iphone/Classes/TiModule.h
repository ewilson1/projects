...
/**
 The base class for all week3demo modules
 */
...
/**
 week3demo Platform calls this method on startup.
 */
-(void)startup;

/**
 week3demo Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 week3demo Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 week3demo Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 week3demo Platform calls this method on resume.
 @param sender The sender of the event.
 */
