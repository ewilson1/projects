...
/**
 Base class for all week3demo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the week3demo view hierarchy (such as wrapped iOS UIViews) was touched.
