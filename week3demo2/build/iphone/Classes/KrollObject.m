...
//@interface week3demo2Object : NSObject
//@end

@interface week3demo2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[week3demo2Object class]])
		{
			for (NSString *key in [[(week3demo2Object*)o modules] allKeys])
			{
