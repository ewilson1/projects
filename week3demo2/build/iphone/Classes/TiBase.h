...
// in simulator we redefine to format for week3demo2 Developer console
...
{\
	NSString * exceptionName = [@"org.week3demo2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week3demo2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIweek3demo2NativeItemNone = -1, 
	UIweek3demo2NativeItemSpinner = -2,
	UIweek3demo2NativeItemProgressBar = -3,
	
	UIweek3demo2NativeItemSlider = -4,
	UIweek3demo2NativeItemSwitch = -5,
	UIweek3demo2NativeItemMultiButton = -6,
	UIweek3demo2NativeItemSegmented = -7,
	
	UIweek3demo2NativeItemTextView = -8,
	UIweek3demo2NativeItemTextField = -9,
	UIweek3demo2NativeItemSearchBar = -10,
	
	UIweek3demo2NativeItemPicker = -11,
	UIweek3demo2NativeItemDatePicker = -12,
	
	UIweek3demo2NativeItemInfoLight = -13,
	UIweek3demo2NativeItemInfoDark = -14,
	
	UIweek3demo2NativeItemDisclosure = -15,
	
	UIweek3demo2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all week3demo2 instances of
