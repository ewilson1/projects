...
/**
 Base class for all week3demo2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the week3demo2 view hierarchy (such as wrapped iOS UIViews) was touched.
