...
@interface wilson_eric_project4Object : KrollCoverageObject {
#else
@interface wilson_eric_project4Object : KrollObject {
#endif
@private
...
extern NSString * wilson_eric_project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	wilson_eric_project4Object *_wilson_eric_project4;
    KrollObject* console;
	BOOL shutdown;
