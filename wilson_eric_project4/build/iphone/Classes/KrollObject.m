...
//@interface wilson_eric_project4Object : NSObject
//@end

@interface wilson_eric_project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[wilson_eric_project4Object class]])
		{
			for (NSString *key in [[(wilson_eric_project4Object*)o modules] allKeys])
			{
