...
// in simulator we redefine to format for wilson_eric_project4 Developer console
...
{\
	NSString * exceptionName = [@"org.wilson_eric_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wilson_eric_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIwilson_eric_project4NativeItemNone = -1, 
	UIwilson_eric_project4NativeItemSpinner = -2,
	UIwilson_eric_project4NativeItemProgressBar = -3,
	
	UIwilson_eric_project4NativeItemSlider = -4,
	UIwilson_eric_project4NativeItemSwitch = -5,
	UIwilson_eric_project4NativeItemMultiButton = -6,
	UIwilson_eric_project4NativeItemSegmented = -7,
	
	UIwilson_eric_project4NativeItemTextView = -8,
	UIwilson_eric_project4NativeItemTextField = -9,
	UIwilson_eric_project4NativeItemSearchBar = -10,
	
	UIwilson_eric_project4NativeItemPicker = -11,
	UIwilson_eric_project4NativeItemDatePicker = -12,
	
	UIwilson_eric_project4NativeItemInfoLight = -13,
	UIwilson_eric_project4NativeItemInfoDark = -14,
	
	UIwilson_eric_project4NativeItemDisclosure = -15,
	
	UIwilson_eric_project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all wilson_eric_project4 instances of
