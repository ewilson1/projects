...
/**
 Base class for all wilson_eric_project4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the wilson_eric_project4 view hierarchy (such as wrapped iOS UIViews) was touched.
