...
@interface wilson_eric_project_1Object : KrollCoverageObject {
#else
@interface wilson_eric_project_1Object : KrollObject {
#endif
@private
...
extern NSString * wilson_eric_project_1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	wilson_eric_project_1Object *_wilson_eric_project_1;
    KrollObject* console;
	BOOL shutdown;
