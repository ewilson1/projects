...
//@interface wilson_eric_project_1Object : NSObject
//@end

@interface wilson_eric_project_1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[wilson_eric_project_1Object class]])
		{
			for (NSString *key in [[(wilson_eric_project_1Object*)o modules] allKeys])
			{
