...
// in simulator we redefine to format for wilson_eric_project_1 Developer console
...
{\
	NSString * exceptionName = [@"org.wilson_eric_project_1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wilson_eric_project_1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIwilson_eric_project_1NativeItemNone = -1, 
	UIwilson_eric_project_1NativeItemSpinner = -2,
	UIwilson_eric_project_1NativeItemProgressBar = -3,
	
	UIwilson_eric_project_1NativeItemSlider = -4,
	UIwilson_eric_project_1NativeItemSwitch = -5,
	UIwilson_eric_project_1NativeItemMultiButton = -6,
	UIwilson_eric_project_1NativeItemSegmented = -7,
	
	UIwilson_eric_project_1NativeItemTextView = -8,
	UIwilson_eric_project_1NativeItemTextField = -9,
	UIwilson_eric_project_1NativeItemSearchBar = -10,
	
	UIwilson_eric_project_1NativeItemPicker = -11,
	UIwilson_eric_project_1NativeItemDatePicker = -12,
	
	UIwilson_eric_project_1NativeItemInfoLight = -13,
	UIwilson_eric_project_1NativeItemInfoDark = -14,
	
	UIwilson_eric_project_1NativeItemDisclosure = -15,
	
	UIwilson_eric_project_1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all wilson_eric_project_1 instances of
