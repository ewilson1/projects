...
@interface wilson_eric_project2Object : KrollCoverageObject {
#else
@interface wilson_eric_project2Object : KrollObject {
#endif
@private
...
extern NSString * wilson_eric_project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	wilson_eric_project2Object *_wilson_eric_project2;
    KrollObject* console;
	BOOL shutdown;
