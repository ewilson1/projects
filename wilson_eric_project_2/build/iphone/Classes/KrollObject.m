...
//@interface wilson_eric_project2Object : NSObject
//@end

@interface wilson_eric_project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[wilson_eric_project2Object class]])
		{
			for (NSString *key in [[(wilson_eric_project2Object*)o modules] allKeys])
			{
