...
// in simulator we redefine to format for wilson_eric_project2 Developer console
...
{\
	NSString * exceptionName = [@"org.wilson_eric_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wilson_eric_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIwilson_eric_project2NativeItemNone = -1, 
	UIwilson_eric_project2NativeItemSpinner = -2,
	UIwilson_eric_project2NativeItemProgressBar = -3,
	
	UIwilson_eric_project2NativeItemSlider = -4,
	UIwilson_eric_project2NativeItemSwitch = -5,
	UIwilson_eric_project2NativeItemMultiButton = -6,
	UIwilson_eric_project2NativeItemSegmented = -7,
	
	UIwilson_eric_project2NativeItemTextView = -8,
	UIwilson_eric_project2NativeItemTextField = -9,
	UIwilson_eric_project2NativeItemSearchBar = -10,
	
	UIwilson_eric_project2NativeItemPicker = -11,
	UIwilson_eric_project2NativeItemDatePicker = -12,
	
	UIwilson_eric_project2NativeItemInfoLight = -13,
	UIwilson_eric_project2NativeItemInfoDark = -14,
	
	UIwilson_eric_project2NativeItemDisclosure = -15,
	
	UIwilson_eric_project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all wilson_eric_project2 instances of
