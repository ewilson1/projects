...
/**
 The base class for all wilson_eric_project2 modules
 */
...
/**
 wilson_eric_project2 Platform calls this method on startup.
 */
-(void)startup;

/**
 wilson_eric_project2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 wilson_eric_project2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 wilson_eric_project2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 wilson_eric_project2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
