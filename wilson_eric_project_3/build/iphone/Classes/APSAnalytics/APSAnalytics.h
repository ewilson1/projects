 ...
 * to send analytic data that can be viewed on the wilson_eric_project_3 Dashboard.
 *
 * For information on getting started with wilson_eric_project_3 Platform Services,
