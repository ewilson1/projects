...
@interface wilson_eric_project_3Object : KrollCoverageObject {
#else
@interface wilson_eric_project_3Object : KrollObject {
#endif
@private
...
extern NSString * wilson_eric_project_3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	wilson_eric_project_3Object *_wilson_eric_project_3;
    KrollObject* console;
	BOOL shutdown;
