...
//@interface wilson_eric_project_3Object : NSObject
//@end

@interface wilson_eric_project_3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[wilson_eric_project_3Object class]])
		{
			for (NSString *key in [[(wilson_eric_project_3Object*)o modules] allKeys])
			{
