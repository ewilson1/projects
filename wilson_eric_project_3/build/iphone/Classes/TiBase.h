...
// in simulator we redefine to format for wilson_eric_project_3 Developer console
...
{\
	NSString * exceptionName = [@"org.wilson_eric_project_3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wilson_eric_project_3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIwilson_eric_project_3NativeItemNone = -1, 
	UIwilson_eric_project_3NativeItemSpinner = -2,
	UIwilson_eric_project_3NativeItemProgressBar = -3,
	
	UIwilson_eric_project_3NativeItemSlider = -4,
	UIwilson_eric_project_3NativeItemSwitch = -5,
	UIwilson_eric_project_3NativeItemMultiButton = -6,
	UIwilson_eric_project_3NativeItemSegmented = -7,
	
	UIwilson_eric_project_3NativeItemTextView = -8,
	UIwilson_eric_project_3NativeItemTextField = -9,
	UIwilson_eric_project_3NativeItemSearchBar = -10,
	
	UIwilson_eric_project_3NativeItemPicker = -11,
	UIwilson_eric_project_3NativeItemDatePicker = -12,
	
	UIwilson_eric_project_3NativeItemInfoLight = -13,
	UIwilson_eric_project_3NativeItemInfoDark = -14,
	
	UIwilson_eric_project_3NativeItemDisclosure = -15,
	
	UIwilson_eric_project_3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all wilson_eric_project_3 instances of
