...
//Rare exceptions to indicate a bug in the _wilson_eric_project_3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for wilson_eric_project_3 proxies.
 */
