...
@interface workingversionObject : KrollCoverageObject {
#else
@interface workingversionObject : KrollObject {
#endif
@private
...
extern NSString * workingversion$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	workingversionObject *_workingversion;
    KrollObject* console;
	BOOL shutdown;
