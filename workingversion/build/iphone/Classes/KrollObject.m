...
//@interface workingversionObject : NSObject
//@end

@interface workingversionObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[workingversionObject class]])
		{
			for (NSString *key in [[(workingversionObject*)o modules] allKeys])
			{
