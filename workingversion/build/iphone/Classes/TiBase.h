...
// in simulator we redefine to format for workingversion Developer console
...
{\
	NSString * exceptionName = [@"org.workingversion." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.workingversion";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIworkingversionNativeItemNone = -1, 
	UIworkingversionNativeItemSpinner = -2,
	UIworkingversionNativeItemProgressBar = -3,
	
	UIworkingversionNativeItemSlider = -4,
	UIworkingversionNativeItemSwitch = -5,
	UIworkingversionNativeItemMultiButton = -6,
	UIworkingversionNativeItemSegmented = -7,
	
	UIworkingversionNativeItemTextView = -8,
	UIworkingversionNativeItemTextField = -9,
	UIworkingversionNativeItemSearchBar = -10,
	
	UIworkingversionNativeItemPicker = -11,
	UIworkingversionNativeItemDatePicker = -12,
	
	UIworkingversionNativeItemInfoLight = -13,
	UIworkingversionNativeItemInfoDark = -14,
	
	UIworkingversionNativeItemDisclosure = -15,
	
	UIworkingversionNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all workingversion instances of
