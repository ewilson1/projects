...
//Rare exceptions to indicate a bug in the _workingversion code (Eg, function that a subclass should have implemented)
...
/**
 The base class for workingversion proxies.
 */
