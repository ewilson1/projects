...
/**
 Base class for all workingversion views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the workingversion view hierarchy (such as wrapped iOS UIViews) was touched.
